...
public class NxCommunityCommunityOrdersSubServiceImpl implements NxCommunityOrdersSubService {
	...
	public List<NxCommunityOrdersSubEntity> querySubsByGoodsId(Map<String, Object> subMap) {
		return nxCommunityOrdersSubDao.querySubsByGoodsId(subMap);
	}
	...
	@Override
	public List<NxCommunityOrdersSubEntity> querySubGoodsByOrderId(Integer integer) {
		return nxCommunityOrdersSubDao.querySubGoodsByOrderId(integer);
	}

	@Override
	public List<NxCommunityOrdersSubEntity> queryCommGoodsOfSubs(Integer fatherId) {
		return nxCommunityOrdersSubDao.queryCommGoodsOfSubs(fatherId);
	}
